...
const char * const BITCOIN_CONF_FILENAME = "aet.conf";
const char * const BITCOIN_PID_FILENAME = "aet.pid";
...
#ifdef WIN32
    // Windows
    return GetSpecialFolderPath(CSIDL_APPDATA) / "Aet";
#else
    fs::path pathRet;
...
#ifdef MAC_OSX
    // Mac
    return pathRet / "Library/Application Support/Aet";
#else
    // Unix
    return pathRet / ".aet";
#endif
