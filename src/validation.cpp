...
#if defined(NDEBUG)
# error "Aet cannot be compiled without assertions."
#endif
...
const std::string strMessageMagic = "Aet Signed Message:\n";
                              ...
                              bool fOverrideMempoolLimit, const CAmount& nAbsurdFee, std::vector<COutPoint>& coins_to_uncache)
{
...

    {
        ...
        {
            LogPrint(BCLog::MEMPOOL, "replacing tx %s with %s for %s AET additional fees, %d delta bytes\n",
...
//         return 0;
    ...
    else if (nHeight < 200)   // 10,000,200
