...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* Aet features */
        {"aet", "masternode", &masternode, true, true, false},
        {"aet", "masternodelist", &masternodelist, true, true, false},
        {"aet", "mnbudget", &mnbudget, true, true, false},
        {"aet", "mnbudgetvoteraw", &mnbudgetvoteraw, true, true, false},
        {"aet", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"aet", "mnsync", &mnsync, true, true, false},
        {"aet", "spork", &spork, true, true, false},
#ifdef ENABLE_WALLET
        {"aet", "obfuscation", &obfuscation, false, false, true}, /* not threadSafe because of SendMoney */
...
void StartRPCThreads()
{
    ...
    if (((mapArgs["-rpcpassword"] == "") ||
        ...
        uiInterface.ThreadSafeMessageBox(strprintf(
                                             _("To use aetd, or the -server option to aet-qt, you must set an rpcpassword in the configuration file:\n"
                                               "%s\n"
                                               ...
                                               "for example: alertnotify=echo %%s | mail -s \"AET Alert\" admin@foo.com\n"),
...
{
    return "> aet-cli " + methodname + " " + args + "\n";
}
